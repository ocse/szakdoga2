...
<div align="center" id="main">
	<div id="header">
        ...
        <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="670" height="50" id="FlashID2" title="reklam_flash">
          ...
          <!--<![endif]-->
            ...
            <div id="logo"><a href="index.php"><img src=image/logo.png alt="logo"></img></a></div>
    ...
    <div id="left" >
      ...
      <div id="fomenu">
        <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="670" height="570" id="FlashID" title="fomenu_flash">
          <param name="movie" value="flash/fomenu51.swf" />
          <param name="quality" value="high" />
          <param name="wmode" value="opaque" />
          <param name="swfversion" value="15.0.0.0" />
          <!-- This param tag prompts users with Flash Player 6.0 r65 and higher to download the latest version of Flash Player. Delete it if you don’t want users to see the prompt. -->
          ...
          <!-- Next object tag is for non-IE browsers. So hide it from IE using IECC. -->
          <!--[if !IE]>-->
          <object type="application/x-shockwave-flash" data="flash/fomenu51.swf" width="670" height="570">
            <!--<![endif]-->
            <param name="quality" value="high" />
            <param name="wmode" value="opaque" />
            <param name="swfversion" value="15.0.0.0" />
